...
// ===========================|| DASHBOARD DEFAULT - DRIVERS CARD ||=========================== //

const DriversCard = ({ isLoading }) => {
    ...
    useEffect(() => {
      ...
      const onDataChange = (snapshot) => {
        ...
        if (drivers) {
          ...
          setDriverCount(driverKeys.length);
        }
      };
            ...
            <Grid container direction="column">
              ...
              <Grid item>
                <Grid container alignItems="center">
                  <Grid item>
                    <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>{driverCount}</Typography>
                  </Grid>
                  <Grid item>
                    <Avatar
                      sx={{
